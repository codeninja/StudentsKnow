package com.coderonin.flvplayer.ui
{
	...
	public class MediaControlPanel extends Sprite
	{
		...
		{
			_duration = value;
			_playDur.text = formatFrames(_duration);
		...
		public function set scrub(value:Number):void
		{
			...
			_playPos.text = formatFrames(_stream.time);
		...
		public function MediaControlPanel(stream:NetStream, hSpace:Number, state:String, fullScreen:Boolean=false)
		{
			_stream = stream;
