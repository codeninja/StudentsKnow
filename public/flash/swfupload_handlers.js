...
function uploadProgress(fileObj, bytesLoaded, bytesTotal) {
	...
	try {
		...
		progress.SetStatus("Your file is uploading. Please do not close out your web browser window.");
	} catch (e) { }
}
...
FileProgress.prototype.SetProgress = function(percentage) {
		...
		this.fileProgressElement.childNodes[3].innerHTML = "<p>" + percentage + "%</p>";
}
